...
> 本App从logo到代码到文档都是AI写的，最终版本也是AI发布的，人类只负责花钱和指手画脚
>
> 大概是最终版本了，如果后续macOS更新了导致api不兼容我会回来更新一下下
...
| 过热 | 鲜艳蓝色光晕 + 随机红色闪光 + HDR 峰值亮度 + 0.5Hz 呼吸脉冲 |
...
- **游戏友好** —— 检测到手柄自动停止渲染；光晕窗口 `ignoresMouseEvents` 全穿透、`sharingType = .none` **不出现在截图与录屏中**
